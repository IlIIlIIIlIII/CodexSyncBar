...
final class CodexSyncBarTests: XCTestCase {
    ...
    func testPopoverKeepsAccountManagementInSettingsAndOffersSafeRefresh() throws {
        ...
        XCTAssertTrue(popover.contains("if isCursorSelected"))
        XCTAssertTrue(popover.contains("cursorAccountSummary\n                    cursorMonthlyUsageCard"))
        XCTAssertTrue(popover.contains("if !isCursorSelected"))
        XCTAssertTrue(popover.contains("CursorQuotaUsageRow("))
        XCTAssertTrue(popover.contains("title: \"Cursor Models\""))
        XCTAssertTrue(popover.contains("title: \"Other Models\""))
        XCTAssertTrue(popover.contains("accessibilityIdentifier(\"cursor-monthly-usage-card\")"))
        XCTAssertTrue(popover.contains("accessibilityID: \"cursor-models-usage-row\""))
        XCTAssertTrue(popover.contains("accessibilityID: \"cursor-other-models-usage-row\""))
